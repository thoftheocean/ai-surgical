...
const outdoorSports = [
  // 跑步/徒步
  'running', 'jogging', 'trail', 'trailrunning', 'marathon', 'ultramarathon',
  'hiking', 'trekking', 'backpacking', 'mountaineering',
  
  // 骑行
  'cycling', 'biking', 'mtb', 'mountainbike', 'roadbike', 'ebike',
  
  // 水上运动
  'surfing', 'surf', 'kayaking', 'paddleboard', 'sup', 'wakeboard',
  'diving', 'snorkeling', 'swimming',
  
  // 极限运动
  'climbing', 'rockclimbing', 'bouldering', 'skydiving', 'paragliding',
  'skateboarding', 'snowboarding', 'skiing',
  
  // 露营/探险
  'camping', 'adventure', 'outdoor', 'outdoors', 'nature', 'wilderness',
  'explore', 'explorer',
  
  // 标签
  'outdoortok', 'outdoorlife', 'getoutside', 'adventuretime',
  'traillife', 'mountainlife', 'camplife', 'vanlife',
  
  // 中文
  '户外', '露营', '徒步', '登山', '骑行', '跑步', '冲浪', '滑雪', '探险'
];
```
...
const fitnessKeywords = [
  ...
  // 户外运动
  'running', 'jogging', 'trail', 'trailrunning', 'marathon',
  'hiking', 'trekking', 'camping', 'mountaineering',
  'cycling', 'biking', 'mtb', 'roadbike',
  'surfing', 'climbing', 'rockclimbing', 'bouldering',
  'skateboarding', 'snowboarding', 'skiing',
  'outdoor', 'outdoors', 'adventure', 'explore',
