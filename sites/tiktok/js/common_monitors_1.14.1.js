!(function () {
  ...
  function _(n, t) {
    ...
    var e,
      ...
      u = [];
    try {
      for (; (void 0 === t || 0 < t--) && !(e = i.next()).done; )
        u.push(e.value);
    } catch (n) {
      o = { error: n };
    } finally {
  ...
  function M(o) {
    return function (r, n) {
      function t(n) {
        ...
        n.viewId &&
          n.viewId !==
            (null === (t = o.config()) || void 0 === t ? void 0 : t.viewId) &&
          (r(e), (e = d(d({}, k(o)), L(n))));
      }
      var e = k(o);
      (o.on("beforeConfig", t),
        ...
        !(
          "html" ===
            (t = (function (n) {
              ...
              n = u.className;
              if (n && v(n))
                for (r = n.split(/\s+/), i = 0; i < r.length; i++)
                  c.push("." + r[i]);
              var a = ["type", "name", "title", "alt"];
              for (i = 0; i < a.length; i++)
                ((e = a[i]),
                  (o = u.getAttribute(e)) && c.push("[" + e + '="' + o + '"]'));
              var f = u,
                s = 1,
                l = !0;
              for (; (f = f.previousElementSibling); )
                (null === (t = f.tagName) || void 0 === t
                  ? void 0
                  : t.toLowerCase()) ===
                  (null === (t = u.tagName) || void 0 === t
                    ? void 0
                    : t.toLowerCase()) &&
                  (f.className === u.className &&
                    a.every(function (n) {
                      return (
                        u.getAttribute(n) ===
                        (null == f ? void 0 : f.getAttribute(n))
                      );
                    }) &&
                    (l = !1),
                  s++);
              ...
              r(
                ...
                Q(
                  (r = function (n) {
                    ...
                    0 !== t.length &&
                      e({ type: "dom", category: "ui." + n.name, message: t });
                  }),
                  "dom",
                ),
              ),
        ...
        ? ((function (n) {
            if (e(n)) {
              if ("function" != typeof Object.getPrototypeOf)
                return "[object Object]" === r.toString.call(n);
    ...
    return function (n) {
      try {
        if (
          ((r = e),
          !(!(t = n) || !r) &&
            !(!pn(t.message, r.message) || !pn(t.stack, r.stack)))
        )
          return void (e = n);
      } catch (n) {
        !(function () {
  ...
  var dn = ["name", "message", "stack", "filename", "lineno", "colno"],
    ...
    bn = [
      ...
      function (o, n) {
          ...
          var e = { type: "capture-global", data: d({}, r) },
            t =
              ...
              (n._w_ = function () {
                try {
                  return (
                    n.handleEvent && x(n.handleEvent) ? n.handleEvent : n
                  ).apply(
                    this,
        ...
        var t = S(),
          r = (function () {
            if ("function" == typeof XMLHttpRequest && x(XMLHttpRequest))
                ...
                c(
                  ...
                  function (o) {
                    return function (n, t, r) {
                      ...
                      return (
                        o &&
                        o.call(this, n, u(t, { function: yn, target: i }), r)
                      );
                    };
                  },
                  !1,
              ...
              e.push(
                c(
                  ...
                  function (e) {
                    return function (n, t, r) {
                      return (
                        null != t && t._w_ && e.call(this, n, t._w_, r),
                        e.call(this, n, t, r)
                      );
                    };
                  },
  ...
  var Bn = function (n, t) {
      ...
      if (r) {
        n = r.tagName;
        if (n && v(n))
          return { url: On(r), tagName: n, xpath: t ? N(r) : void 0 };
      }
    },
    Dn = function (n, t) {
      var r = n.url,
        ...
        r =
          ((n = r),
          (r = T()) && n
            ? (((r = r.createElement("a")).href = n), r.href)
            : ""),
        t = t(r)[0];
          ...
          var i = (function (n) {
              ...
              if (n && "number" == typeof n.length)
                return {
                  next: function () {
                    return {
                      value: (n = n && e >= n.length ? void 0 : n) && n[e++],
                      done: !n,
                    };
                  },
                };
  ...
  var Vn = function (n) {
      ...
      return (
        ...
        ((i =
          0 === s.x && 0 === s.y && 0 === s.width && 0 === s.height
            ? { x: s.x, y: p }
            : { x: s.x, y: s.y }),
        (u = i.x),
        (c = i.y),
        (a =
          0 === f.x && 0 === f.y && 0 === f.width && 0 === f.height
            ? { x: f.x, y: p }
            : { x: f.x, y: f.y }),
        (i = a.x),
        (a = a.y),
    ...
    et = [
      ...
      function (n, t, r) {
        var e = _(r, 4),
          ...
          u = R(),
          c = (function () {
            if (S() && x(window.PerformanceEventTiming))
        ...
        function l(n) {
          ...
          (r || y.length < 10 || n.duration > t.latency) &&
            (r
              ? (r.entries.push(n),
                (r.latency = Math.max(r.latency, n.duration)))
              : ((n = {
                  id: n.interactionId,
                  latency: n.duration,
                  entries: [n],
        ...
        function p() {
          ...
          n &&
            ((a.value = n.latency),
            (n = n.entries[0].target) && (a.extra = { element: N(n) }));
        }
        function v(t) {
          (t.interactionId && l(t),
            "first-input" !== t.entryType ||
              y.some(function (n) {
                return n.entries.some(function (n) {
                  return (
                    t.duration === n.duration && t.startTime === n.startTime
                  );
                });
              }) ||
              l(t));
        ...
        t.push(
          r[0](function () {
            (t.push(U(u, v, rt, 40)),
              "interactionId" in c.prototype && t.push(U(u, v, "first-input")));
            var n = i();
            t.push(
              n[0](function (n) {
          ...
          f = Xn(
            function (n) {
              ...
              return (
                ...
                {
                  ev_type: V,
                  payload: { isBounced: n, timing: u, navigation_timing: t },
                }
              );
            },
            n,
      ...
      (ct = (function () {
        ...
        try {
          ...
          for (
            ...
            if (e === i && c[t].innerHTML && c[t].innerHTML.trim() === u)
              return c[t];
          }
          return null;
        }
  ...
  (vt(un, function (u) {
    ...
    vt(xn, function (t) {
      t.on("init", function () {
        var n =
          null === (n = t.config()) || void 0 === n ? void 0 : n.plugins[xn];
        !(function (t, n) {
          ...
          r &&
            ((r = _n(
              function (n) {
                (t.getBreadcrumbs &&
                  (n.payload.breadcrumbs = t.getBreadcrumbs()),
                  t.report(n));
              },
              (n = []),
              [
      ...
      v.on("init", function () {
        ...
        p &&
          ...
          (a = function (n) {
            n =
              (n.ev_type === J &&
                (n.payload.name === tt[0] || n.payload.name === et[0])) ||
              n.ev_type === z
                ? n
                : d(d({}, n), { overrides: u });
            v.report(n);
                ...
                v = function (n) {
                  ...
                  (t && n.url === t) ||
                    ...
                    (n.url &&
                      ((c && n.url === p) ||
                        ((p = n.url),
                        (n = Dn(n, l)) && r({ ev_type: Y, payload: n }))));
                };
              return (
                n.push(
                  o[0](function (n) {
    ...
    vt(An, function (e) {
      e.on("init", function () {
        var n,
          t,
          r =
            null === (t = e.config()) || void 0 === t ? void 0 : t.plugins[An];
        ((n = e),
          (r = D((t = r), Nn)) &&
            ((t = []),
            In(
